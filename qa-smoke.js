...
assert(index.includes('source-guards.js?v=20260824fix4'),'Source integration cache version not current');
...
assert(source.includes('exact-source-pages.js?v=20260824fix4'),'Source loader is not using the refreshed exact-source controller');
